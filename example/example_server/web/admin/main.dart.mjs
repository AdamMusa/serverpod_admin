...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1399: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      _1400: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      _1401: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      _1402: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      _1403: (x0,x1,x2) => x0.exportKey(x1,x2),
      _1404: (x0,x1,x2) => x0.setItem(x1,x2),
      _1405: (x0,x1) => x0.getRandomValues(x1),
      _1406: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      _1407: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      _1414: Date.now,
      ...
      _1452: Object.is,
      _1453: o => o instanceof Array,
      _1454: (a, i) => a.push(i),
      _1458: a => a.pop(),
      _1459: (a, i) => a.splice(i, 1),
      _1460: (a, s) => a.join(s),
      _1461: (a, s, e) => a.slice(s, e),
      _1463: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1464: a => a.length,
      _1466: (a, i) => a[i],
      _1467: (a, i, v) => a[i] = v,
      _1469: o => {
      ...
      _1470: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1472: o => o instanceof Uint8Array,
      _1473: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1474: o => o instanceof Int8Array,
      _1475: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1476: o => o instanceof Uint8ClampedArray,
      _1477: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1478: o => o instanceof Uint16Array,
      _1479: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1480: o => o instanceof Int16Array,
      _1481: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1482: o => o instanceof Uint32Array,
      _1483: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1484: o => o instanceof Int32Array,
      _1485: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1487: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1488: o => o instanceof Float32Array,
      _1489: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1490: o => o instanceof Float64Array,
      _1491: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1492: (t, s) => t.set(s),
      _1493: l => new DataView(new ArrayBuffer(l)),
      _1494: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1496: o => o.buffer,
      _1497: o => o.byteOffset,
      _1498: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1499: (b, o) => new DataView(b, o),
      _1500: (b, o, l) => new DataView(b, o, l),
      _1501: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1502: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1503: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1504: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1505: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1506: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1507: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1508: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1509: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1510: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1511: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1512: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1515: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1516: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1517: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1518: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1519: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1520: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1533: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1534: (handle) => clearTimeout(handle),
      _1535: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1536: (handle) => clearInterval(handle),
      _1537: (c) =>
      ...
      _1555: o => o.length,
      _1557: (o, i) => o[i],
      _1558: f => f.dartFunction,
      _1559: () => ({}),
      _1560: () => [],
      _1562: () => globalThis,
      _1563: (constructor, args) => {
      ...
      _1565: (o, p) => o[p],
      _1566: (o, p, v) => o[p] = v,
      _1567: (o, m, a) => o[m].apply(o, a),
      _1569: o => String(o),
      _1570: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _1571: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1571(f,arguments.length,x0) }),
      _1572: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1572(f,arguments.length,x0,x1) }),
      _1573: o => {
      ...
      _1574: o => [o],
      _1575: (o0, o1) => [o0, o1],
      _1576: (o0, o1, o2) => [o0, o1, o2],
      _1577: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1621: (x0,x1) => x0.item(x1),
      _1622: (x0,x1) => x0.removeChild(x1),
      _1624: x0 => ({type: x0}),
      _1625: (x0,x1) => new Blob(x0,x1),
      _1627: () => new FileReader(),
      _1628: (x0,x1) => x0.readAsArrayBuffer(x1),
      ...
      _1634: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1634(f,arguments.length,x0,x1,x2) }),
      _1635: (x0,x1) => x0.forEach(x1),
      _1636: x0 => x0.getReader(),
      _1637: x0 => x0.cancel(),
      _1638: x0 => x0.read(),
      _1639: x0 => x0.trustedTypes,
      _1640: (x0,x1) => { x0.src = x1 },
      ...
      _1645: x0 => ({createScriptURL: x0}),
      _1646: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1647: (x0,x1) => x0.querySelectorAll(x1),
      _1648: x0 => x0.random(),
      ...
      _1787: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      _1788: f => finalizeWrapper(f, function() { return dartInstance.exports._1788(f,arguments.length) }),
      _1837: (x0,x1) => { x0.responseType = x1 },
      _1838: x0 => x0.response,
      _1914: x0 => x0.style,
      _2113: (x0,x1) => { x0.nonce = x1 },
      _2273: (x0,x1) => { x0.download = x1 },
      _2298: (x0,x1) => { x0.href = x1 },
      _2391: (x0,x1) => { x0.src = x1 },
      _2843: (x0,x1) => { x0.accept = x1 },
      _2857: x0 => x0.files,
      _2883: (x0,x1) => { x0.multiple = x1 },
      _2901: (x0,x1) => { x0.type = x1 },
      _3151: (x0,x1) => { x0.src = x1 },
      _3157: (x0,x1) => { x0.async = x1 },
      _3159: (x0,x1) => { x0.defer = x1 },
      _3620: () => globalThis.window,
      _3660: x0 => x0.document,
      _3682: x0 => x0.navigator,
      _3937: x0 => x0.isSecureContext,
      _3940: x0 => x0.crypto,
      _3944: x0 => x0.trustedTypes,
      _3945: x0 => x0.sessionStorage,
      _3946: x0 => x0.localStorage,
      _4005: x0 => x0.message,
      ...
      _6230: x0 => x0.length,
      _6232: x0 => x0.length,
      _6289: () => globalThis.document,
      _6370: x0 => x0.body,
      _6372: x0 => x0.head,
      _6702: (x0,x1) => { x0.id = x1 },
      _6729: x0 => x0.children,
      _8048: x0 => x0.value,
      _8050: x0 => x0.done,
      _8230: x0 => x0.size,
      _8231: x0 => x0.type,
      _8238: x0 => x0.name,
      _8239: x0 => x0.lastModified,
      _8244: x0 => x0.length,
      _8250: x0 => x0.result,
      _8747: x0 => x0.url,
      _8749: x0 => x0.status,
