...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1354: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      _1355: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      _1356: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      _1357: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      _1358: (x0,x1,x2) => x0.exportKey(x1,x2),
      _1359: (x0,x1,x2) => x0.setItem(x1,x2),
      _1360: (x0,x1) => x0.getRandomValues(x1),
      _1361: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      _1362: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      _1369: Date.now,
      ...
      _1581: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1585: x0 => x0.send(),
      ...
      _1599: (x0,x1) => x0.removeChild(x1),
      _1601: x0 => ({type: x0}),
      _1602: (x0,x1) => new Blob(x0,x1),
      _1604: () => new FileReader(),
      _1605: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1606: () => new AbortController(),
      _1607: x0 => x0.abort(),
      _1608: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1609: (x0,x1) => globalThis.fetch(x0,x1),
      _1610: (x0,x1) => x0.get(x1),
      _1611: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1611(f,arguments.length,x0,x1,x2) }),
      _1612: (x0,x1) => x0.forEach(x1),
      _1613: x0 => x0.getReader(),
      _1614: x0 => x0.cancel(),
      _1615: x0 => x0.read(),
      _1616: x0 => x0.trustedTypes,
      _1617: (x0,x1) => { x0.src = x1 },
      _1618: (x0,x1) => x0.createScriptURL(x1),
      _1619: x0 => x0.nonce,
      _1620: (x0,x1) => x0.debug(x1),
      _1621: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1621(f,arguments.length,x0) }),
      _1622: x0 => ({createScriptURL: x0}),
      _1623: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1624: (x0,x1) => x0.querySelectorAll(x1),
      _1625: o => o instanceof Array,
      _1630: a => a.pop(),
      _1631: (a, i) => a.splice(i, 1),
      _1632: (a, s) => a.join(s),
      _1633: (a, s, e) => a.slice(s, e),
      _1635: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1636: a => a.length,
      _1638: (a, i) => a[i],
      _1639: (a, i, v) => a[i] = v,
      _1641: o => {
      ...
      _1642: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1644: o => o instanceof Uint8Array,
      _1645: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1646: o => o instanceof Int8Array,
      _1647: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1648: o => o instanceof Uint8ClampedArray,
      _1649: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1650: o => o instanceof Uint16Array,
      _1651: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1652: o => o instanceof Int16Array,
      _1653: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1654: o => o instanceof Uint32Array,
      _1655: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1656: o => o instanceof Int32Array,
      _1657: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1659: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1660: o => o instanceof Float32Array,
      _1661: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1662: o => o instanceof Float64Array,
      _1663: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1664: (t, s) => t.set(s),
      _1665: l => new DataView(new ArrayBuffer(l)),
      _1666: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1668: o => o.buffer,
      _1669: o => o.byteOffset,
      _1670: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1671: (b, o) => new DataView(b, o),
      _1672: (b, o, l) => new DataView(b, o, l),
      _1673: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1674: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1675: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1676: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1677: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1678: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1679: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1680: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1681: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1682: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1683: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1684: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1687: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1688: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1689: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1690: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1691: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1692: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1693: Function.prototype.call.bind(Number.prototype.toString),
      _1694: Function.prototype.call.bind(BigInt.prototype.toString),
      _1695: Function.prototype.call.bind(Number.prototype.toString),
      _1696: (d, digits) => d.toFixed(digits),
      _1830: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      _1831: (module,f) => finalizeWrapper(f, function() { return module.exports._1831(f,arguments.length) }),
      _1880: (x0,x1) => { x0.responseType = x1 },
      _1881: x0 => x0.response,
      _1957: x0 => x0.style,
      _2156: (x0,x1) => { x0.nonce = x1 },
      _2316: (x0,x1) => { x0.download = x1 },
      _2341: (x0,x1) => { x0.href = x1 },
      _2434: (x0,x1) => { x0.src = x1 },
      _2886: (x0,x1) => { x0.accept = x1 },
      _2900: x0 => x0.files,
      _2926: (x0,x1) => { x0.multiple = x1 },
      _2944: (x0,x1) => { x0.type = x1 },
      _3194: (x0,x1) => { x0.src = x1 },
      _3200: (x0,x1) => { x0.async = x1 },
      _3202: (x0,x1) => { x0.defer = x1 },
      _3663: () => globalThis.window,
      _3703: x0 => x0.document,
      _3725: x0 => x0.navigator,
      _3980: x0 => x0.isSecureContext,
      _3983: x0 => x0.crypto,
      _3987: x0 => x0.trustedTypes,
      _3988: x0 => x0.sessionStorage,
      _3989: x0 => x0.localStorage,
      _4048: x0 => x0.message,
      _4114: x0 => x0.userAgent,
      _4115: x0 => x0.vendor,
      _4165: x0 => x0.data,
      _4166: x0 => x0.origin,
      _6223: x0 => x0.type,
      ...
      _6273: x0 => x0.length,
      _6275: x0 => x0.length,
      _6332: () => globalThis.document,
      _6413: x0 => x0.body,
      _6415: x0 => x0.head,
      _6745: (x0,x1) => { x0.id = x1 },
      _6772: x0 => x0.children,
      _8091: x0 => x0.value,
      _8093: x0 => x0.done,
      _8273: x0 => x0.size,
      _8274: x0 => x0.type,
      _8281: x0 => x0.name,
      _8282: x0 => x0.lastModified,
      _8287: x0 => x0.length,
      _8293: x0 => x0.result,
      _8790: x0 => x0.url,
      _8792: x0 => x0.status,
      _8794: x0 => x0.statusText,
      _8795: x0 => x0.headers,
      _8796: x0 => x0.body,
      _11200: (x0,x1) => { x0.display = x1 },
      _12422: x0 => x0.name,
      _12426: x0 => x0.subtle,
      _13132: () => globalThis.console,
