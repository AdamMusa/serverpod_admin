...
--
-- Class Setting as table settings
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('example', '20260703153142890-auth-idp-34', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260703153142890-auth-idp-34', "timestamp" = now();
