...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i5;
import 'comment/comment.dart' as _i6;
import 'greeting.dart' as _i7;
import 'person/person.dart' as _i8;
import 'post/post.dart' as _i9;
import 'setting/setting.dart' as _i10;
...
class Protocol extends _i1.SerializationManagerServer {
    ...
    _i2.TableDefinition(
      ...
      columns: [
        ...
        _i2.ColumnDefinition(
          ...
          isNullable: false,
          dartType: 'String',
          columnDefault: '\'A comment title\'::text',
        ),
        _i2.ColumnDefinition(
          name: 'description',
          columnType: _i2.ColumnType.text,
          isNullable: false,
          dartType: 'String',
          columnDefault: '\'This is a comment\'::text',
        ),
        _i2.ColumnDefinition(
          name: 'postId',
          columnType: _i2.ColumnType.bigint,
  ...
  T deserialize<T>(
    ...
    if (t == _i10.Setting) {
      return _i10.Setting.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i10.Setting?>()) {
      return (data != null ? _i10.Setting.fromJson(data) : null) as T;
    }
    if (t == List<_i6.Comment>) {
      return (data as List).map((e) => deserialize<_i6.Comment>(e)).toList()
          as T;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'Setting') {
      return deserialize<_i10.Setting>(data['data']);
    }
